...
export const ROUTE_META: Record<string, PageMeta> = {
  ...
  "/paper": {
    ...
    ogDescription: "Λ=hf/c² unifies Maxwell, Planck, Einstein, Shannon, and Russell into one compression state framework. 25,600 orthogonal channels. arXiv submission pending.",
    ogType: "article",
    twitterTitle: "Theory of Compression States — Preprint",
    twitterDescription: "Unified physics: information, field, and matter as compression states of a primordial oscillation. Λ=hf/c². 25,600 Hilbert space channels. AGPL-3.0.",
  ...
  "/founders": {
    ...
    bodyHtml: `<h1>The Founding Architects — Maxwell, Planck, Einstein, Tesla, Russell, QM, Shannon</h1><p>NexusOS does not run on invented systems. It runs on the equations of seven scientists who described the physical structure of reality. Every Ψ channel, every fee calculation, every compression state traces directly to one of these names.</p><h2>The Lineage</h2><dl><dt>James Clerk Maxwell (1831–1879)</dt><dd>Maxwell's equations govern every WNSP packet. The propagation condition ∇²E = μ₀ε₀ ∂²E/∂t² is validated on every transaction.</dd><dt>Max Planck (1858–1947)</dt><dd>E=hf. Planck's constant h = 6.626 × 10⁻³⁴ J·s is the direct anchor for every NXT transaction fee. No photon energy — no fee.</dd><dt>Albert Einstein (1879–1955)</dt><dd>E=mc². Combined with E=hf gives Λ=hf/c² — the compression state operator that governs every address and channel in NexusOS.</dd><dt>Nikola Tesla (1856–1943)</dt><dd>The bifilar coil geometry used in the PHR-1 physical resonator traces directly to Tesla's bifilar patent. The standing wave structure it generates is the physical implementation of the compression state field.</dd><dt>Walter Russell (1871–1963)</dt><dd>Russell's nine-octave wave system maps to the NexusOS authority band hierarchy. WGM resonance condition 2πR=nλ validates his octave formula. His 9th octave peak = nuclear magic number 114 = SYSTEM band.</dd><dt>Heisenberg, Schrödinger, Dirac (Quantum Mechanics)</dt><dd>Hilbert space orthogonality ⟨Ψᵢ|Ψⱼ⟩ = 0 is guaranteed by quantum mechanics. NexusOS uses this as channel isolation — not software policy.</dd><dt>Claude Shannon (1916–2001)</dt><dd>Shannon entropy H = −Σpᵢlog₂pᵢ scores channel coherence in Spectral Search. Information theory is the measure of signal quality in WNSP.</dd></dl><nav><ul><li><a href="${BASE}/oscillating-quanta">Theory of Compression States</a></li><li><a href="${BASE}/proof">Physics Proofs</a></li><li><a href="${BASE}/octave-layers">Russell Octave Layers</a></li></ul></nav>`,
  },
  "/joint-venture": {
...
<nav><a href="/hardware-spec">Hardware Specification</a> · <a href="/oscillating-quanta">First Principles</a> · <a href="/compression-explorer">Compression Explorer</a> · <a href="/open">Open Charter</a></nav>`,
  ...
  "/rune-etching": {
    title: "Rune Etching — Etch Bitcoin Runes on Mainnet | NexusOS",
    description: "Etch new Bitcoin Runes on mainnet using the NexusOS Rune toolchain. WNSP spectral verification, Runestone encoding, CPFP mint chaining, and Orbital Treasury fee routing.",
    canonical: `${BASE}/rune-etching`,
    ogTitle: "Rune Etching — NexusOS Bitcoin Rune Creator",
    ogDescription: "Create Bitcoin Runes on mainnet. Runestone encoding, CPFP mint chaining, spectral verification. NexusOS Orbital Treasury fee routing.",
    twitterTitle: "NexusOS Rune Etching",
    twitterDescription: "Etch Bitcoin Runes on mainnet. Runestone encoding, CPFP mint chaining, spectral verification.",
    jsonLd: softwareApp({ url: `${BASE}/rune-etching`, name: "NexusOS Rune Etching", description: "Bitcoin Rune etching tool with WNSP spectral verification, correct Runestone encoding, and CPFP mint chaining for production mainnet use." }),
    bodyHtml: `<h1>Rune Etching — Etch Bitcoin Runes on Mainnet</h1><p>The NexusOS Rune Etching interface allows you to etch new Bitcoin Runes on mainnet with WNSP spectral verification. The tool handles Runestone encoding, safe UTXO selection (Rune Guard), and CPFP mint chaining automatically.</p><nav><ul><li><a href="${BASE}/rune-mint">Rune Mint</a></li><li><a href="${BASE}/nxt-campaign">NEXUS•WAVELENGTH Rune</a></li><li><a href="${BASE}/blockchain">Block Explorer</a></li></ul></nav>`,
  },
  "/rune-mint": {
  ...
  "/etch-rune": {
    title: "Etch Rune — Bitcoin Rune Creation Interface | NexusOS",
    description: "Create Bitcoin Runes using the NexusOS Rune etching interface. Tapscript commit/reveal for short names, Runestone encoding, and safe UTXO selection.",
    canonical: `${BASE}/rune-etching`,
    jsonLd: softwareApp({ url: `${BASE}/rune-etching`, name: "Etch Rune — NexusOS", description: "Bitcoin Rune creation with tapscript commit/reveal, Runestone encoding, and Rune Guard safe UTXO selection." }),
    bodyHtml: `<h1>Etch Rune — Bitcoin Rune Creation Interface</h1><p>Create Bitcoin Runes with the NexusOS Rune etching interface. Short names (under 13 characters) use a tapscript commit/reveal with a mandatory 6-block gap. All Runestone encoding uses correct tag numbers.</p><nav><ul><li><a href="${BASE}/rune-etching">Full Rune Etching Tool</a></li><li><a href="${BASE}/nxt-campaign">NEXUS•WAVELENGTH Rune</a></li></ul></nav>`,
  },
  "/rune-staking": {
  ...
  "/btc-bridge": {
    title: "BTC Bridge — Bitcoin to NexusOS Protocol Bridge",
    description: "The BTC Bridge connects Bitcoin's UTXO layer to the NexusOS physics stack. Wrap satoshis as wSATS, route Bitcoin Rune balances to spectral addresses, and settle on-chain.",
    canonical: `${BASE}/wnsp-bridge`,
    jsonLd: softwareApp({ url: `${BASE}/wnsp-bridge`, name: "BTC Bridge", description: "Bridge connecting Bitcoin's UTXO layer to the NexusOS physics stack. Wraps satoshis as wSATS, routes Rune balances to spectral addresses." }),
    bodyHtml: `<h1>BTC Bridge — Bitcoin to NexusOS Protocol Bridge</h1><p>The BTC Bridge connects Bitcoin's UTXO layer to the NexusOS physics stack. Wrap satoshis as wSATS, route Bitcoin Rune balances to spectral addresses, and settle on-chain with physics-based fees.</p><nav><ul><li><a href="${BASE}/wsats">wSATS</a></li><li><a href="${BASE}/wnsp-bridge">WNSP Bridge</a></li></ul></nav>`,
  },
