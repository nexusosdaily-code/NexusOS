...
export const DOMAIN_META: Record<string, PageMeta> = {
  ...
  "snic.io": {
    ...
    jsonLd: hardwareProduct({ name: "SNIC — Spectral Network Interface Card", url: "https://snic.io/", description: `Photonic network interface card with ${PSI_CHANNELS} orthogonal channels (${PSI_CHANNEL_FORMULA}). First public disclosure 2026-05-16. AGPL-3.0.`, image: SNIC_IMAGE }),
  ...
  "spectralmirror.io": {
    ...
    canonical: "https://spectralmirror.io/",
    ogType: "website",
    ...
    jsonLd: techArticle({ url: "https://spectralmirror.io/", name: "Spectral Mirror — Electromagnetic Archive", description: "Live archive of every WNSP transmission CE-encoded by wavelength. Records map to Ψ channels in the 380–780 nm visible spectrum. Recording began 2 May 2026.", about: "WNSP protocol, CE encoding, spectral archive, electromagnetic spectrum" }),
  ...
  "www.spectralmirror.io": {
    ...
    jsonLd: techArticle({ url: "https://spectralmirror.io/", name: "Spectral Mirror — Electromagnetic Archive", description: "Live archive of every WNSP transmission CE-encoded by wavelength. Recording began 2 May 2026.", about: "WNSP protocol, CE encoding, spectral archive, electromagnetic spectrum" }),
...
export const ROUTE_META: Record<string, PageMeta> = {
  ...
  "/universal-address": {
    ...
    description: "Act 4: Every compression state in the universe already has a unique Ψ address derived from physics. No central authority. Censorship-impossible. WNSP is the first operable implementation of the universe's own namespace. First disclosed 2026-07-06.",
    canonical: `${BASE}/universal-address`,
    ogTitle: "The Address — Ψ as Universal Namespace",
    ogDescription: "Every compression state has exactly one Ψ(wdm,oam,pol,dir) address — derived from physics, not assigned by any authority. You cannot block a frequency. Act 4 of the NexusOS sequence.",
    ogType: "article",
    twitterTitle: "The Address — Ψ as Universal Namespace",
    twitterDescription: "TCP/IP = human convention. DNS = human convention. Ψ = physics. block(Ψ) ⟺ violate Maxwell ⟺ impossible. NexusOS Act 4.",
    ...
    bodyHtml: `<h1>The Address — Ψ as Universal Namespace</h1><p>Act 4 of the NexusOS physics sequence. Every compression state Λ = hf/c² is uniquely identified by its frequency f. Every frequency maps to a unique Ψ(wdm, oam, pol, dir) coordinate. Therefore every compression state in the universe already has exactly one address — derived from physics, not assigned by any authority.</p><h2>The Completeness Theorem</h2><p>∀ Λ ∈ Universe : ∃! Ψ(wdm, oam, pol, dir). The WNSP namespace is complete, unique, and authority-free. ∎</p><h2>Namespace Dimensions</h2><ul><li>WDM: 256 wavelength channels (380–780 nm, 1.5625 nm resolution)</li><li>OAM: 50 orbital angular momentum modes (orthogonal by quantum mechanics)</li><li>Pol: 2 polarisation states (H/V, ⟨H|V⟩ = 0)</li><li>Dir: 2 propagation directions (+k̂/−k̂, first disclosed 2026-07-02)</li><li>Total: 256 × 50 × 2 × 2 = 51,200 orthogonal Ψ channels</li></ul><h2>Censorship Impossibility</h2><p>block(Ψ) ⟺ suppress(f) ⟺ violate Maxwell ⟺ impossible. A Ψ address cannot be revoked. It is derived from the frequency of an electromagnetic wave — it exists whether or not any human system uses it.</p><h2>The Sequence Complete</h2><ul><li><a href="${BASE}/oscillating-quanta">Act 1 — Theory of Compression States: Λ = hf/c²</a></li><li><a href="${BASE}/universal-one">Act 2 — The Universal ONE: f₀ derives Λ</a></li><li><a href="${BASE}/matter-protocol">Act 3 — The Mechanism: ΔE = hf₀(2ⁿ²−2ⁿ¹)</a></li><li><a href="${BASE}/universal-address">Act 4 — The Address: ∀ Λ : ∃! Ψ</a></li></ul>`,
  },
  "/matter-protocol": {
    title: "The Mechanism — Controlled Octave Inversion · NexusOS",
    description: "Act 3: Matter manipulation as a precise calculation. ΔE = hf₀(2ⁿ²−2ⁿ¹) is the transition energy. The WNSP Ψ channel is the delivery mechanism. Falsifiable predictions included. First disclosed 2026-07-06.",
    canonical: `${BASE}/matter-protocol`,
    ogTitle: "The Mechanism — Controlled Octave Inversion",
    ogDescription: "Matter is a standing wave at octave n. Manipulation = delivering ΔE = hf₀(2ⁿ²−2ⁿ¹) at the exact WNSP Ψ channel. Act 3 of the NexusOS physics sequence.",
    ogType: "article",
    twitterTitle: "The Mechanism — Controlled Octave Inversion",
    twitterDescription: "Electron at n≈17.8 above f₀. Proton at n≈28.6. ΔE = hf₀(2ⁿ²−2ⁿ¹). The protocol for controlled matter manipulation. NexusOS Act 3.",
