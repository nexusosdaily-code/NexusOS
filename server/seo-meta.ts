...
<nav><a href="/hardware-spec">Hardware Specification</a> · <a href="/oscillating-quanta">First Principles</a> · <a href="/compression-explorer">Compression Explorer</a> · <a href="/open">Open Charter</a></nav>`,
  ...
  "/rune-etching": {
    ...
    description: "WNSP•WAVELENGTHSCRIPT is the NexusOS canonical Bitcoin Rune. Track etch status, mint progress, and on-chain deployment of the physics-based token on the Bitcoin Runes protocol.",
    canonical: `${BASE}/rune-etching`,
    ogTitle: "WNSP•WAVELENGTHSCRIPT — NexusOS Canonical Rune",
    ogDescription: "The NexusOS canonical Bitcoin Rune. Track etch status, mint progress, and on-chain deployment. Physics-based token on the Bitcoin Runes protocol.",
    twitterTitle: "WNSP•WAVELENGTHSCRIPT — NexusOS Rune",
    twitterDescription: "NexusOS canonical Bitcoin Rune. Track etch status, mint progress, and on-chain deployment.",
    jsonLd: softwareApp({ url: `${BASE}/rune-etching`, name: "WNSP•WAVELENGTHSCRIPT", description: "The NexusOS canonical Bitcoin Rune. Status dashboard for the WNSP•WAVELENGTHSCRIPT etch, mint progress, and on-chain deployment on the Bitcoin Runes protocol." }),
    bodyHtml: `<h1>WNSP•WAVELENGTHSCRIPT — NexusOS Canonical Bitcoin Rune</h1><p>WNSP•WAVELENGTHSCRIPT is the canonical Bitcoin Rune for the NexusOS physics stack. This page tracks the etch status, mint progress, and on-chain deployment of the token on the Bitcoin Runes protocol. The Rune is anchored to the WNSP spectral address system and settled on Bitcoin mainnet.</p><nav><ul><li><a href="${BASE}/nxt-campaign">NEXUS•WAVELENGTH — NXT Token</a></li><li><a href="${BASE}/etch-rune">Etch a Custom Rune</a></li><li><a href="${BASE}/rune-mint">Rune Mint</a></li><li><a href="${BASE}/blockchain">Block Explorer</a></li></ul></nav>`,
  },
  "/rune-mint": {
  ...
  "/etch-rune": {
    ...
    bodyHtml: `<h1>Etch a Custom Rune — Create Your Own Bitcoin Rune</h1><p>The NexusOS Etch-a-Rune tool lets you create your own Bitcoin Rune with a custom image. Choose a name, upload artwork, and etch on Bitcoin mainnet. Short names (under 13 characters) automatically use a tapscript commit/reveal workflow with the required 6-block gap. Rune Guard ensures only safe UTXOs are selected, protecting any existing Rune balances.</p><nav><ul><li><a href="${BASE}/rune-etching">WNSP•WAVELENGTHSCRIPT — NexusOS Canonical Rune</a></li><li><a href="${BASE}/rune-mint">Rune Mint</a></li><li><a href="${BASE}/nxt-campaign">NXT Token</a></li></ul></nav>`,
  },
  "/rune-staking": {
