...
<nav><a href="/hardware-spec">Hardware Specification</a> · <a href="/oscillating-quanta">First Principles</a> · <a href="/compression-explorer">Compression Explorer</a> · <a href="/open">Open Charter</a></nav>`,
  ...
  "/the-entangler": {
    ...
    jsonLd: techArticle({ url: `${BASE}/the-entangler`, name: "The Entangler — Bell State Generation and WNSP Quantum Repeater", description: "Act 16 of the 16-act NexusOS physics sequence. Bell states, entanglement swapping, CHSH S=2√2, quantum repeater chain. DLCZ Ψ-channel entanglement. Claim 31. AGPL-3.0.", about: "bell state, entanglement swapping, CHSH, quantum repeater, DLCZ, Bell inequality, concurrence, quantum teleportation, WNSP, NexusOS" }),
    bodyHtml: `<h1>The Entangler — Bell State Generation and WNSP Quantum Repeater</h1><p>Act 16 of the NexusOS physics sequence. First disclosed 2026-07-19. AGPL-3.0. Founder: Te Rata Pou.</p><h2>Bell States</h2><p>The four maximally entangled two-qubit states: |Φ⁺⟩=(|00⟩+|11⟩)/√2, |Φ⁻⟩=(|00⟩-|11⟩)/√2, |Ψ⁺⟩=(|01⟩+|10⟩)/√2, |Ψ⁻⟩=(|01⟩-|10⟩)/√2. All have concurrence C=1.</p><h2>Entanglement Swapping</h2><p>|Φ⁺⟩_AB ⊗ |Φ⁺⟩_BC → BSM(B) → |Φ⁺⟩_AC. Two Bell pairs merged by BSM at intermediate node creates A–C entanglement without direct contact. Teleportation fidelity F_tele=(2F+1)/3.</p><h2>CHSH Inequality</h2><p>S=E(a,b)-E(a,b')+E(a',b)+E(a',b') ≤ 2 (classical), ≤ 2√2≈2.828 (Tsirelson bound). Loophole-free violations: Hensen 2015, Giustina 2015, Shalm 2015.</p><h2>WNSP Repeater — Claim 31</h2><p>Without repeaters: F ∝ e^(-L/L_att). With n SNIC swap nodes: L_total = n × L₀. Claim 31: SNIC nodes as BSM-capable quantum repeater switch points using Ψ(wdm,oam,pol) address space as the repeater topology.</p><h2>The 16-Act Sequence</h2><ul><li><a href="${BASE}/oscillating-quanta">Act 1 — Theory of Compression States</a></li><li><a href="${BASE}/universal-one">Act 2 — The Universal ONE</a></li><li><a href="${BASE}/unified-compression-theory">Act 3 — Unified Compression Theory</a></li><li><a href="${BASE}/matter-protocol">Act 4 — The Mechanism</a></li><li><a href="${BASE}/universal-address">Act 5 — The Address</a></li><li><a href="${BASE}/element-catalogue">Act 6 — The Catalogue</a></li><li><a href="${BASE}/standing-wave-trap">Act 7 — The Trap</a></li><li><a href="${BASE}/lossless-channel">Act 8 — The Lossless Channel</a></li><li><a href="${BASE}/resonance-cavity">Act 9 — The Cavity</a></li><li><a href="${BASE}/polariton-exchange">Act 10 — The Exchange</a></li><li><a href="${BASE}/the-emitter">Act 11 — The Emitter</a></li><li><a href="${BASE}/the-network">Act 12 — The Network</a></li><li><a href="${BASE}/the-observer">Act 13 — The Observer</a></li><li><a href="${BASE}/the-memory">Act 14 — The Memory</a></li><li><a href="${BASE}/cosmic-lattice">Act 15 — The Void</a></li><li><a href="${BASE}/the-entangler">Act 16 — The Entangler</a></li></ul>`,
  },
  "/the-observer": {
  ...
  "/the-emitter": {
    ...
    jsonLd: techArticle({ url: `${BASE}/the-emitter`, name: "The Emitter — Purcell Effect", description: "Purcell-enhanced spontaneous emission and single-photon sources from WNSP Ψ channels. The weak-coupling limit of the Jaynes-Cummings exchange.", about: "Purcell effect, single-photon source, cavity QED, LDOS, β-factor, WNSP, NexusOS" }),
