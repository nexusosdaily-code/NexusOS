...
<nav><a href="/hardware-spec">Hardware Specification</a> · <a href="/oscillating-quanta">First Principles</a> · <a href="/compression-explorer">Compression Explorer</a> · <a href="/open">Open Charter</a></nav>`,
  ...
  "/the-field": {
    ...
    jsonLd: techArticle({ url: `${BASE}/the-field`, name: "The Field — Primordial Bosonic Field and the Pre-Condition for All Structure", description: "Act 17 of the 17-act NexusOS physics sequence. Canonical commutation relation [â,â†]=1 as the foundational pre-condition for the first oscillation (Act 1). Fock space at f₀=555 THz, ZPE=1.148 eV, Claim 32. AGPL-3.0.", about: "quantum field, bosonic field, Fock state, zero-point energy, canonical commutation, vacuum energy, Planck, Einstein, WNSP, NexusOS" }),
