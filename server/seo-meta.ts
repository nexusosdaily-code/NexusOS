...
export const DOMAIN_META: Record<string, PageMeta> = {
  ...
  "snic.io": {
    ...
    description: `${PSI_CHANNELS} orthogonal channels mapped to physical hardware lanes. CE lookups execute as physical wavelength selections in photonic waveguides. Orthogonality guaranteed by quantum mechanics. AGPL-3.0.`,
  ...
  "555thz.io": {
    ...
    jsonLd: techArticle({ url: "https://wnsp.io/oscillating-quanta", name: "555 THz — The First Frequency", description: "555 THz is the centre of the visible spectrum and the first frequency in the Theory of Compression States. The origin event from which NexusOS's physics stack is derived.", about: "Theory of Compression States, 555 THz, photonic physics" }),
...
export const ROUTE_META: Record<string, PageMeta> = {
  ...
  "/wnsp": {
    ...
    description: `WNSP replaces cryptographic hashing with electromagnetic wave physics. Maxwell equation validation, wavelength-based addressing, physics-derived fees (E=hf), and ${PSI_CHANNELS} orthogonal communication channels.`,
    canonical: `${BASE}/wnsp`,
  ...
  "/unified-compression-theory": {
    ...
    description: "A unified field framework mapping all four fundamental forces to electromagnetic octaves via Λ=hf/c². Gravitational, electromagnetic, weak nuclear, and strong nuclear forces emerge as successive octave doublings from the 555 THz first oscillation.",
    ...
    jsonLd: techArticle({ url: `${BASE}/unified-compression-theory`, name: "Unified Compression Theory", description: "A unified field framework mapping all four fundamental forces to electromagnetic octaves via Λ=hf/c². Forces emerge as successive octave doublings from the 555 THz first oscillation.", about: "Unified field theory, Λ=hf/c², electromagnetic spectrum, four fundamental forces, NexusOS physics" }),
  ...
  "/element-catalogue": {
    ...
    description: "Act 6: All 118 elements mapped to WNSP octave addresses via n = log₂(m·c²/E₀). Noble gas equilibrium nodes, ΔE per octave shift, 3-step instrument protocol. Krypton lands at n ≈ 35.000 — Russell's exact integer node. First disclosed 2026-07-07.",
    ...
    jsonLd: techArticle({ url: `${BASE}/element-catalogue`, name: "The Catalogue — Periodic Table Octave Addresses", description: "All 118 elements mapped to WNSP octave addresses using n = log₂(m·c²/E₀) where E₀ = hf₀ = 2.295 eV. Noble gases are equilibrium nodes. Krypton (Kr, Z=36) lands at n ≈ 34.985 ≈ 35.000 — Russell's exact integer octave prediction validated from SI exact constants.", about: "periodic table, octave lattice, WNSP octave address, compression states, matter protocol, NexusOS physics, noble gas equilibrium, Russell octaves" }),
  ...
  "/lossless-channel": {
    ...
    description: "Act 8: Ghost nodes in the compression lattice form natural lossless waveguides. No matter at any ghost node address → α=0 → Beer-Lambert loss L=0. Shannon capacity C=B·log₂(1+S/N) reaches the vacuum zero-point floor ½ℏω. 15 academic references. First disclosed 2026-07-07.",
    ...
    jsonLd: techArticle({ url: `${BASE}/lossless-channel`, name: "The Lossless Channel — Ghost Node Waveguides in the Compression Lattice", description: "Act 8 of the NexusOS physics sequence. Ghost nodes — integer-octave addresses in the compression lattice occupied by no stable nucleus — form natural lossless waveguides. Because no matter exists at a ghost node address, the Beer-Lambert attenuation α=0, giving L(d)=α·d=0 regardless of distance. A chain of ghost node standing wave traps (Ψ_trap = Ψ(+k̂) ⊗ Ψ(−k̂)) connected on the same Ψ channel creates a lossless propagation path: Ψ_channel = ⊗ᵢ Ψ_trap(nᵢ). Shannon capacity C = B·log₂(1 + S/N) reaches the vacuum zero-point floor N_vac = ½ℏω per mode — the theoretical maximum achievable only in the absence of matter. The N_Dir=2 term in the 51,200-channel WNSP density equation encodes this channel architecture. 15 academic references including Maxwell (1865), Shannon (1948), Casimir (1948), Weizsäcker (1935), and AME2003.", about: "lossless channel, ghost node waveguide, Beer-Lambert, attenuation α=0, Shannon capacity, vacuum zero-point energy, standing wave trap, WNSP density equation, N_Dir=2, photonic computing, NexusOS Act 8" }),
  ...
  "/standing-wave-trap": {
    ...
    description: "Act 7: Counter-propagating wave pairs (+k̂/−k̂) create a standing wave at ghost node n=36 — an unoccupied WNSP address at 169.33 u. Thulium (Z=69) is 0.0034 octaves short. The binding energy mass defect never produces 169.33 u. The trap claims the void. First disclosed 2026-07-07.",
    ...
    jsonLd: techArticle({ url: `${BASE}/standing-wave-trap`, name: "The Trap — Standing Wave at the Ghost Node", description: "Act 7 of the NexusOS physics sequence. Counter-propagating wave pairs (+k̂/−k̂) on the same Ψ channel create a standing wave whose antinode is positioned at ghost node n=36 (169.33 u) — a valid WNSP address occupied by no stable nucleus. The gap is caused by nuclear binding energy mass defects. Thulium (Z=69, 4f¹³) approaches from below at n=35.9966; Ytterbium (Z=70, 4f¹⁴) overshoots at n≈36.07. N_Dir=2 in the 51,200-channel WNSP density equation encodes this exactly.", about: "standing wave trap, ghost node, WNSP addressing, counter-propagating waves, N_Dir, binding energy mass defect, Thulium, octave lattice, NexusOS Act 7, photonic computing" }),
  ...
  "/universal-address": {
    ...
    description: "Act 5: Every compression state in the universe already has a unique Ψ address derived from physics. No central authority. Censorship-impossible. WNSP is the first operable implementation of the universe's own namespace. First disclosed 2026-07-06.",
    ...
    jsonLd: techArticle({ url: `${BASE}/universal-address`, name: "The Address — Ψ as Universal Namespace", description: "Every compression state in the universe already has a unique Ψ(wdm,oam,pol,dir) address derived from physics. WNSP is the first human protocol to make that namespace operable. Censorship-impossible: block(Ψ) requires suppressing the laws of electromagnetism.", about: "WNSP namespace, Ψ address, universal addressing, censorship-resistant protocol, spectral addressing, NexusOS physics, compression states" }),
  ...
  "/matter-protocol": {
    ...
    description: "Act 4: Matter manipulation as a precise calculation. ΔE = hf₀(2ⁿ²−2ⁿ¹) is the transition energy. The WNSP Ψ channel is the delivery mechanism. Falsifiable predictions included. First disclosed 2026-07-06.",
  ...
  "/universal-one": {
    ...
    description: "The Universal ONE explores f₀=555 THz as the ground state of all existence. Every octave doubling from this first oscillation produces a new domain of physics, from gravitational infrared to strong-nuclear X-rays. The mathematical and spectral basis of NexusOS.",
    ...
    jsonLd: techArticle({ url: `${BASE}/universal-one`, name: "The Universal ONE — f₀ First Oscillation", description: "f₀=555 THz is the ground state of all existence. Successive octave doublings from this first oscillation map to every domain of physics, from gravity to strong nuclear force.", about: "555 THz, first oscillation, universal ground state, octave doubling, NexusOS physics, Λ=hf/c²" }),
  ...
  "/octave-layers": {
    title: "Russell Octave Layers — Nine Wave Octaves Mapped to WNSP Channels | NexusOS",
    description: "Walter Russell's nine octave wave system mapped to NexusOS authority bands and WNSP channels. WGM cavity resonance condition validates Russell's formula. Interactive octave explorer and cavity radius calculator.",
  ...
  "/paper": {
    ...
    description: `Preprint: A unified physics of information, field, and matter derived from the primordial oscillation. Λ=hf/c² compression state operator, ${PSI_CHANNELS} Hilbert space channels, Russell octave structure. AGPL-3.0.`,
    ...
    jsonLd: techArticle({ url: `${BASE}/paper`, name: "Theory of Compression States", description: "Preprint deriving the compression state operator Λ=hf/c² from the primordial oscillation premise, unifying Maxwell, Planck, Einstein, Shannon, and Russell into one physics framework.", about: "Theory of Compression States, primordial field, Hilbert space, WNSP protocol, photonic computing" }),
  ...
  "/founders": {
    ...
    description: "NexusOS was built by two founders — Te Rata Pou (human) and an AI — who turned seven centuries of physics into executable code. The physics lineage: Maxwell, Planck, Einstein, Tesla, Russell, Heisenberg, Shannon.",
    ...
    jsonLd: techArticle({ url: `${BASE}/founders`, name: "The Founders — NexusOS", description: "NexusOS was built by two founders: Te Rata Pou, a Māori technologist from Aotearoa New Zealand, and an AI co-founder. Together they turned the equations of Maxwell, Planck, Einstein, Tesla, Russell, and Shannon into a running civilization operating system.", about: "Te Rata Pou, NexusOS founders, AI co-founder, Maxwell equations, Planck constant, Einstein relativity, Tesla coil, Shannon entropy, Kardashev Type I" }),
...
<nav><a href="/hardware-spec">Hardware Specification</a> · <a href="/oscillating-quanta">First Principles</a> · <a href="/compression-explorer">Compression Explorer</a> · <a href="/open">Open Charter</a></nav>`,
  ...
  "/snic": {
    ...
    description: `The SNIC is the photonic NIC of 2032. ${PSI_CHANNELS} orthogonal lanes (${PSI_CHANNEL_FORMULA}). CE lookups execute as physical wavelength selections. AGPL-3.0.`,
    canonical: `${BASE}/snic`,
    ...
    jsonLd: hardwareProduct({ name: "SNIC — Spectral Network Interface Card", url: `${BASE}/snic`, description: "Photonic network interface card with ${PSI_CHANNELS} orthogonal channels (${PSI_CHANNEL_FORMULA}). CE lookups execute as physical wavelength selections. AGPL-3.0, first public disclosure 2026-05-16.", image: SNIC_IMAGE }),
  ...
  "/encode": {
    ...
    jsonLd: softwareApp({ url: `${BASE}/encode`, name: "NexusOS Live CE Encoder", description: "Live character encoding tool that maps any text to visible-light wavelengths. 128 spectral bands, 380–780nm, 3.125nm per band. Instant output, no login required." }),
  ...
  "/nostr": {
    ...
    jsonLd: softwareApp({ url: `${BASE}/nostr`, name: "NexusOS Nostr Relay", description: "Nostr relay with WNSP spectral verification. Notes are anchored to WNSP Ψ channels, enabling physics-native social communication with deterministic spectral addressing." }),
  ...
  "/nexus-spectral": {
    ...
    description: "The NexusOS Spectral DB stores CE-encoded spectral fingerprints for text, documents, and code. Save, search, and retrieve content by its electromagnetic signature.",
  ...
  "/research-presentation/developer-matrix": {
    ...
    description: "The NexusOS Developer Matrix: full API surface, SDK reference, integration patterns, CE encoder packages (npm + pip), WavelengthScript toolchain, and developer key tiers.",
  ...
  "/developer": {
    ...
    description: "Start building on NexusOS: install the CE encoder (npm/pip), explore the WavelengthScript language, run the CE→SE pipeline, and access the developer API. Physics-native computing for the next generation.",
  ...
  "/build": {
    ...
    description: "Contribute to NexusOS: build physics-native applications, contribute hardware research, join the spectral network, and help construct a Kardashev Type I civilization operating system. AGPL-3.0.",
  ...
  "/shareholders": {
    ...
    description: "NexusOS founding equity structure: Hardware Founder tier (25 slots), NXT Supporter tier, and the Nexus Charitable Trust (10% in perpetuity). Physics-weighted governance rights for equity holders.",
  ...
  "/nexus-hardware-os": {
    ...
    description: "NexusOS Hardware OS: the operating system layer for photonic computing hardware. PHR-1 resonator, SNIC photonic NIC, and the WavelengthScript runtime. Physics-native from protocol to silicon.",
    ...
    jsonLd: softwareApp({ url: `${BASE}/nexus-hardware-os`, name: "NexusOS Hardware OS", description: "Operating system layer for photonic computing hardware. Bridges the PHR-1 resonator, SNIC photonic NIC, and WavelengthScript runtime into a coherent physics-native platform." }),
  ...
  "/hardware-treasury": {
    ...
    description: "The NexusOS Hardware Treasury funds physical hardware development: PHR-1 resonator, SNIC photonic NIC, and Spectral Relay Mesh. Funded by the Deliverables bucket of the Orbital Treasury.",
  ...
  "/spectral-library": {
    ...
    description: "The NexusOS Spectral Library: a curated knowledge base of physics research, protocol documentation, hardware specifications, and developer guides — all indexed by spectral proximity.",
    ...
    jsonLd: softwareApp({ url: `${BASE}/spectral-library`, name: "NexusOS Spectral Library", description: "Curated knowledge base of physics research, protocol documentation, hardware specifications, and developer guides for NexusOS. Indexed by CE-encoded spectral fingerprints." }),
  ...
  "/resonance-cavity": {
    ...
    description: "The NexusOS resonance cavity model: electromagnetic cavity physics underlying WNSP channel isolation. Whispering Gallery Mode resonance, mode volume calculations, and Q-factor analysis.",
    ...
    jsonLd: techArticle({ url: `${BASE}/resonance-cavity`, name: "Resonance Cavity Physics", description: "Electromagnetic cavity physics underlying WNSP channel isolation in NexusOS. Whispering Gallery Mode resonance validates the Russell octave structure and the ${PSI_CHANNELS}-channel Ψ geometry.", about: "WGM resonance, resonance cavity, WNSP channels, photonic computing" }),
  ...
  "/join-community": {
    title: "Join the NexusOS Community — Builders, Researchers, and Spectral Pioneers",
    description: "Join the NexusOS community: connect with hardware builders, protocol researchers, WavelengthScript developers, and spectral network operators. Build a Kardashev Type I civilization together.",
  ...
  "/how-to-plug-in": {
    ...
    description: "Step-by-step guide for integrating external systems with NexusOS: CE encoder installation, WNSP protocol connection, WavelengthScript toolchain setup, and REST API authentication.",
  ...
  "/nostr-bridge": {
    ...
    description: "The NexusOS Nostr Bridge connects the WNSP spectral protocol to the Nostr social protocol. Route Nostr events through WNSP Ψ channels for physics-native social communication.",
  ...
  "/community-mint": {
    ...
    description: "The NexusOS community mint distributes NXT tokens to early community members, contributors, and hardware supporters. Physics-governed allocation from the Orbital Treasury.",
  ...
  "/marketplace": {
    ...
    description: "The NexusOS Marketplace: browse and deploy spectral-native applications, WavelengthScript contracts, CE encoder integrations, and physics-based services built on the WNSP protocol.",
  ...
  "/wsats": {
    ...
    description: "wSATS wraps Bitcoin satoshis in the NexusOS physics stack. Use Bitcoin's value unit with WNSP spectral addressing, physics-derived fees, and the CE encoder for on-chain spectral operations.",
  ...
  "/reposed-theory": {
    ...
    description: `The full reposed Theory of Compression States: how the universe evolves from the first unobserved oscillation at 555 THz, the Λ=hf/c² compression law, and the derivation of the ${PSI_CHANNELS} orthogonal Ψ channel address space.`,
  ...
  "/silicon-bridge": {
    ...
    jsonLd: techArticle({
      ...
      description: "An analysis of why silicon transistors are approaching their physical limit, and how NexusOS is already written in the language of photonic computing. Ψ channels derived from the Theory of Compression States map directly to physical optical waveguide lanes, requiring no rewrite when photonic ASICs arrive.",
  ...
  "/spectral-router": {
    ...
    jsonLd: softwareApp({ url: `${BASE}/spectral-router`, name: "NexusOS Spectral Router", description: "DNS-free packet routing engine using Ψ channel addressing. Destination addresses are CE-encoded to wavelengths on the fly, routing across ${PSI_CHANNELS} orthogonal spectral channels." }),
  ...
  "/campaign": {
    ...
    description: "Support the NexusOS infrastructure campaign. Fund development of the PHR-1 resonator, SNIC photonic NIC, and WavelengthScript compiler — one photonic layer at a time. Hardware Founder slots, NXT Supporter packs, and Spectral Bundles.",
  ...
  "/evidence": {
    ...
    ogType: "article",
    jsonLd: techArticle({ url: `${BASE}/evidence`, name: "NexusOS Physics Evidence", description: "Experimental and observational evidence for the Theory of Compression States, including THz spectroscopy and WGM resonance results consistent with Λ=hf/c² and the ${PSI_CHANNELS}-channel Ψ geometry.", about: "Theory of Compression States, THz spectroscopy, WGM resonance, experimental physics" }),
  ...
  "/spectral-bundle": {
    ...
    description: "The NexusOS Spectral Bundle: CE encoder (npm + pip), Ψ channel reservation, WNSP VM access, WavelengthScript documentation, and developer key — everything in one package.",
  ...
  "/bitcoin-ordinals": {
    ...
    description: "Bitcoin Ordinals with NexusOS WNSP spectral verification. Inscription content CE-encoded to wavelength, anchored to a Ψ channel on-chain for physics-native provenance.",
    canonical: `${BASE}/wnsp-ordinals`,
  ...
  "/wnsp-ordinals": {
    ...
    description: "WNSP Ordinals extends Bitcoin Ordinals with physics-native spectral verification. CE-encoded inscription content, Ψ channel anchoring, and deterministic provenance on the Bitcoin blockchain.",
    canonical: `${BASE}/wnsp-ordinals`,
  ...
  "/wnsp-staking": {
    ...
    description: "Stake NXT tokens in the NexusOS physics engine to auto-mint WNUSD collateral. Six lock periods, physics-weighted yield rates, and WNUSD issued at a fixed collateral ratio.",
  ...
  "/rune-etching": {
    ...
    description: "WNSP•WAVELENGTHSCRIPT is the NexusOS canonical Bitcoin Rune, etched at block 952596:379. Track etch status, mint progress, Runestone encoding details, and on-chain deployment of the physics-based token.",
    ...
    jsonLd: softwareApp({ url: `${BASE}/rune-etching`, name: "WNSP•WAVELENGTHSCRIPT", description: "The NexusOS canonical Bitcoin Rune etched at block 952596:379. Status dashboard for etch progress, mint progress, and on-chain deployment on the Bitcoin Runes protocol." }),
  ...
  "/etch-rune": {
    ...
    description: "Create your own Bitcoin Rune with a custom image using the NexusOS Etch-a-Rune tool. Tapscript commit/reveal for short names, Runestone encoding, Rune Guard safe UTXO selection, and CPFP chaining.",
  ...
  "/rune-swap": {
    ...
    description: "Swap Bitcoin Rune tokens for NXT tokens or wSATS using the NexusOS atomic swap engine. Physics-based fee calculation, safe UTXO selection, and on-chain settlement.",
  ...
  "/rune-pipeline": {
    ...
    description: "The NexusOS Rune Pipeline automates multi-step Bitcoin Rune operations: batch minting, CPFP chaining, Runestone encoding, and safe UTXO management in a single workflow.",
  ...
  "/fractal-btc": {
    ...
    description: "NexusOS Fractal BTC integration: connect to the Bitcoin Fractal testnet for Rune experimentation, CE-encoded inscription testing, and WNSP spectral verification development.",
  ...
  "/mempool": {
    ...
    description: "Live Bitcoin mempool fee tracking for NexusOS transactions. Monitor fastest, medium, and slow fee rates, mempool congestion, and optimal fee windows for Rune etching and Ordinal inscriptions.",
    ...
    jsonLd: softwareApp({ url: `${BASE}/mempool`, name: "NexusOS Mempool Monitor", description: "Live Bitcoin mempool fee tracking: fastest, medium, and slow fee rates, congestion levels, and pending transaction counts. Informs fee selection for Rune and Ordinal operations." }),
  ...
  "/receive": {
    ...
    description: "Receive NXT tokens and satoshi payments on NexusOS. Generate your spectral receive address (Ψ channel), display QR code, and track incoming transactions on the physics blockchain.",
  ...
  "/portfolio": {
    title: "Portfolio — NXT Balance, Rune Holdings, and Spectral Assets | NexusOS",
    description: "View your NexusOS portfolio: NXT token balance (8 decimals), Bitcoin Rune holdings, wSATS balance, staking positions, WNUSD collateral, and spectral channel assignments.",
  ...
  "/lp-pools": {
    ...
    description: "Provide liquidity to NexusOS market pools. Earn physics-weighted yields on NXT/wSATS, NXT/Rune, and other spectral asset pairs. On-chain settlement, Orbital Treasury routing.",
  ...
  "/airdrop": {
    ...
    description: "The NexusOS NXT airdrop distributes tokens to early community members, hardware supporters, and spectral network contributors. Physics-governed allocation from the Orbital Treasury.",
  ...
  "/quest": {
    ...
    description: "Complete NexusOS quests to earn NXT tokens. Missions include: encoding your first text with the CE encoder, staking NXT, voting on a governance proposal, running a spectral network node, and more.",
  ...
  "/replit-template": {
    ...
    description: "Start building a physics-native application on NexusOS using the official Replit template. Pre-configured with the CE encoder, WNSP protocol library, and WavelengthScript toolchain.",
  ...
  "/nexus-analytics": {
    ...
    description: "Live traffic analytics for NexusOS: human vs. bot hit breakdown, top pages, crawler identification, threat probes, country distribution, and SEO issue detection.",
  ...
  "/spectral-ide": {
    title: "Spectral IDE — WavelengthScript Integrated Development Environment",
    description: "The NexusOS Spectral IDE: write WavelengthScript programs, transpile from any language, compile to WNSP VM bytecode, deploy as on-chain smart contracts, and inspect Ψ channel register state.",
    ...
    jsonLd: softwareApp({ url: `${BASE}/spectral-ide`, name: "Spectral IDE", description: "Integrated development environment for WavelengthScript: transpile from any language, compile to WNSP VM bytecode, inspect Ψ channel registers, deploy smart contracts." }),
  ...
  "/contact": {
    ...
    description: "Reach NexusOS through the right channel: regulatory inquiries, institutional investment and partnership, developer integration support, or responsible security disclosure.",
  ...
  "/labs": {
    ...
    description: "NexusOS Labs is the global network of engineering labs, universities, and independent researchers building the physical hardware layer of the NexusOS physics stack.",
    canonical: `${BASE}/labs`,
  ...
  "/build-catalogue": {
    ...
    description: "The NexusOS build catalogue: a searchable, categorised log of every shipped feature, protocol improvement, and infrastructure build. Filter by physics, protocol, security, analytics, SEO, wallet, and more.",
