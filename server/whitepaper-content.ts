...
export const WHITEPAPER_CONTENT = [
  ...
  "- **OAM** — orbital angular momentum mode (50 modes, 0–49)",
  "- **Pol** — polarisation state (H or V)",
  "",
  "256 × 50 × 2 × 2 (N_Dir) = **51,200 orthogonal communication channels**",
  "",
  ...
  "",
  "The 51,200 orthogonal Ψ channels map directly to physical hardware lanes. When photonic ASICs arrive, NexusOS doesn't need a migration — it *is* the photonic architecture, running on simulation hardware in the interim.",
  "",
