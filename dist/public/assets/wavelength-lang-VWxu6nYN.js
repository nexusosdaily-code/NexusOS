import{a as j,j as e}from"./vendor-query-BqLxTKzc.js";import{u as G}from"./use-page-meta-BHtL6y3o.js";import{L as W}from"./index-r75eLKcP.js";import{A as z}from"./arrow-left-CQKpjeGu.js";import{C as P}from"./code-xml-Cqgby9Q2.js";import{L as B}from"./layers-BDr7Sz7o.js";import{Z as H}from"./zap-DiI0IM3X.js";import{A as _}from"./atom-DEIwn8AD.js";import{C as R}from"./copy-BPZsYKkD.js";import{P as q}from"./play-Cy4VtnTu.js";import{C as O}from"./cpu-Fze1VCYS.js";import{R as D}from"./radio-CuNnd8N2.js";import{B as F}from"./book-open-DlCPK29P.js";import{C as K}from"./chevron-right-qTrZxO94.js";import"./vendor-radix-Bg2fqeVo.js";import"./vendor-charts-DAxvRQzT.js";function E(d){return d<450?"#8b00ff":d<495?"#2563eb":d<520?"#06b6d4":d<565?"#16a34a":d<590?"#ca8a04":d<625?"#ea580c":"#dc2626"}function $(d){return d<450?"SYSTEM":d<495?"AUTH":d<520?"STREAM":d<565?"LOGIC":d<590?"INTERFACE":d<625?"EVENT":"STORAGE"}function g(d){const b=d.toUpperCase().split("").map(p=>p.charCodeAt(0)).filter(p=>p>=32&&p<=126);b.length||b.push(77);const f=b.reduce((p,n)=>p+n,0)/b.length,o=parseFloat((380+(f-32)/94*400).toFixed(2)),c=parseFloat((299792458/(o*1e-9)/1e12).toFixed(2)),w=Math.floor((o-380)/4)+1,s=b.reduce((p,n)=>p+n,0)%100,S=b.length%2===0?"H":"V";return{nm:o,thz:c,psi:`Ψ(${w},${s},${S})`,band:$(o)}}function U(d,b){if(!d.trim())return"";const f=d.split(`
