import{a as j,j as e}from"./vendor-query-BqLxTKzc.js";import{u as G}from"./use-page-meta-BHtL6y3o.js";import{L as W}from"./index-CZmx5F7R.js";import{A as z}from"./arrow-left-BUM8J4zk.js";import{C as P}from"./code-xml-CWfT9l2M.js";import{L as B}from"./layers-BICb1Ui9.js";import{Z as H}from"./zap-DJZIHsKB.js";import{A as _}from"./atom-WwnyWVUW.js";import{C as R}from"./copy-COkvqy-b.js";import{P as q}from"./play-gsR7-RE6.js";import{C as O}from"./cpu-D_kUIvJe.js";import{R as D}from"./radio-CJJePC-b.js";import{B as F}from"./book-open-CGHb_rZR.js";import{C as K}from"./chevron-right-C_zxHy6y.js";import"./vendor-radix-Bg2fqeVo.js";import"./vendor-charts-DAxvRQzT.js";function E(d){return d<450?"#8b00ff":d<495?"#2563eb":d<520?"#06b6d4":d<565?"#16a34a":d<590?"#ca8a04":d<625?"#ea580c":"#dc2626"}function $(d){return d<450?"SYSTEM":d<495?"AUTH":d<520?"STREAM":d<565?"LOGIC":d<590?"INTERFACE":d<625?"EVENT":"STORAGE"}function g(d){const b=d.toUpperCase().split("").map(p=>p.charCodeAt(0)).filter(p=>p>=32&&p<=126);b.length||b.push(77);const f=b.reduce((p,n)=>p+n,0)/b.length,o=parseFloat((380+(f-32)/94*400).toFixed(2)),c=parseFloat((299792458/(o*1e-9)/1e12).toFixed(2)),w=Math.floor((o-380)/4)+1,s=b.reduce((p,n)=>p+n,0)%100,S=b.length%2===0?"H":"V";return{nm:o,thz:c,psi:`Ψ(${w},${s},${S})`,band:$(o)}}function U(d,b){if(!d.trim())return"";const f=d.split(`
...
`)}function Z(d){if(!d.trim())return{assembly:"",hex:"",manifest:[],instrCount:0};const b=[],f=new Map;let o=0;function c(n,i,l,h,m,x){b.push({off:o,op:n,mnem:i,args:l,nm:m,ch:x,cmt:h}),n!==0&&(o+=8)}c(0,".WNSP","v1.0","NexusOS WNSP Bytecode · AGPL-3.0"),c(0,".ARCH","WDM256·OAM50·POL2·DIR2","51,200 orthogonal Ψ channels"),c(0,".MODEL","Λ=hf/c² SPECTRAL","Einstein first-principle execution"),c(0,"","",""),o=0;for(const n of d.split(`
