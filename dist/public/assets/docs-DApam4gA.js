import{r as _,Z as g,j as e,L as t,B as u,A as x,C as s}from"./index-rZyRwy6x.js";import{B as O}from"./badge-DfuSAdRg.js";import{R as f}from"./radio-OBirjZYR.js";import{L as b}from"./layers-mMTa78WM.js";import{A as v}from"./atom-CSKpotk9.js";import{C as a}from"./cpu-hyvlRZEh.js";import{B as L}from"./building-2-CAD_Io1d.js";import{S as I}from"./scale-0ahLCB0p.js";import{S as w}from"./shield-DZnyuaPo.js";import{C as N}from"./code-C-cTyqAi.js";import{E as o}from"./external-link-BrE_X_9m.js";import{B as M}from"./book-open-BVqZoHpV.js";const y={substrate:{title:"Lambda Gate Substrate v4",icon:a,color:"from-purple-500 to-pink-500",content:[{heading:"Core Theory",text:`The Lambda Gate Substrate is the foundational layer where all NexusOS operations occur as wavefield transformations.
...
- Constitutional enforcement at substrate level`}]},wascii:{title:"WNSP Protocol — Two-Layer Standard",icon:N,color:"from-blue-500 to-cyan-500",content:[{heading:"Overview — Two Operating Runtimes, One Protocol",text:`NexusOS runs on two distinct runtimes that work in sync:
...
**Result: 23 passed, 0 failed**`}]},consensus:{title:"Proof of Spectrum Consensus",icon:f,color:"from-green-500 to-emerald-500",content:[{heading:"Spectral Diversity Requirement",text:`Unlike Proof of Work (51% hashpower) or Proof of Stake (51% stake), Proof of Spectrum requires validators across ALL spectral regions.
...
- Inflation is physically impossible`}]},bhls:{title:"BHLS Floor System",icon:w,color:"from-red-500 to-pink-500",content:[{heading:"Basic Human Living Standard",text:`BHLS guarantees every citizen a minimum floor of resources:
...
4. **Governance Allocation** (10%)
   - Voted by Sigma consensus`}]},governance:{title:"Planetary Governance",icon:I,color:"from-indigo-500 to-purple-500",content:[{heading:"Authority Band Registry",text:`7-tier governance hierarchy mapped to wavelengths:
...
- Natural consensus emergence through interference`}]},infrastructure:{title:"K1 Infrastructure",icon:L,color:"from-cyan-500 to-blue-500",content:[{heading:"Kardashev Scale Progress",text:`NexusOS is building toward Type I civilization:
...
**Target:** 5×10¹⁶ watts (penultimate step to Type I)`}]},hardware:{title:"Hardware Control Layer",icon:a,color:"from-rose-500 to-red-500",content:[{heading:"PHR-1 Syncbox Controller",text:`The PHR-1 (Planetary Harmonic Resonator) is the physical hardware interface for NexusOS:
...
Scales with impedance match quality`}]},massless:{title:"Massless Technologies",icon:v,color:"from-violet-500 to-purple-500",content:[{heading:"Core Derivation: Λ = hf/c²",text:`Mass as derivative of frequency:
...
Where C_i = coherence of technology i`}]},catchBasin:{title:"CZC Catch Basin",icon:b,color:"from-blue-500 to-indigo-500",content:[{heading:"Coherence Zenith Coefficient",text:`The CZC Catch Basin is the coherence accumulation mechanism at the heart of NexusOS:
...
- POST /api/czc/sync - Sync with K1 Orchestration`}]},sop:{title:"Spectral Orthogonal Protocol (SOP)",icon:f,color:"from-cyan-500 to-blue-500",content:[{heading:"The Core Idea",text:`Two things are **orthogonal** when they are completely independent — knowing everything about one tells you absolutely nothing about the other.
