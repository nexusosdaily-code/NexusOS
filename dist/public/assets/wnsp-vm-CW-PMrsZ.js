import{a as N,j as e}from"./vendor-react-Dbq4-fkY.js";import{u as M}from"./use-page-meta-BCnBVlPQ.js";import{L as U}from"./vendor-router-BNSZfxZx.js";import{R as q}from"./spectral-visuals-DNKRW39c.js";import{f as B,b as G,Q as O,bV as F,ap as _,ae as D,K as Z,R as J,Z as K,J as X}from"./vendor-icons-taAWd6pV.js";function f(o){return o<450?"#8b00ff":o<495?"#2563eb":o<520?"#06b6d4":o<565?"#16a34a":o<590?"#ca8a04":o<625?"#ea580c":"#dc2626"}function j(o){return o<450?"SYSTEM":o<495?"AUTH":o<520?"STREAM":o<565?"LOGIC":o<590?"INTERFACE":o<625?"EVENT":"STORAGE"}function b(o){const h=o.toUpperCase().split("").map(r=>r.charCodeAt(0)).filter(r=>r>=32&&r<=126);h.length||h.push(77);const m=h.reduce((r,l)=>r+l,0)/h.length,n=parseFloat((380+(m-32)/94*400).toFixed(2)),s=Math.floor((n-380)/4)+1,a=h.reduce((r,l)=>r+l,0)%50,i=h.length%2===0?"H":"V";return{nm:n,psi:`Ψ(${s},${a},${i})`,band:j(n)}}function Y(o){if(!o.trim())return[];const h=[];let m=0;function n(s,a,i,r,l,p,u){h.push({off:m,op:s,mnem:a,args:i,nm:l,ch:p,cmt:r,...u}),s!==0&&(m+=8)}for(const s of o.split(`
