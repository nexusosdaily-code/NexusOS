import{j as e,c as he}from"./vendor-query-Bv9H5-RN.js";import{r as x}from"./vendor-router-tr6KpmeX.js";import{u as fe}from"./use-page-meta-BRxgrg9H.js";import{c as I}from"./index-oAtzuvcb.js";import{B as ge}from"./badge-DB_1vnD-.js";import{B as J}from"./button-IMjXHTFq.js";import{I as Q}from"./input-DTTQWgA7.js";import{L as S}from"./label-DzIZ3ZAB.js";import{T as be,a as ve,b as B,c as U}from"./tabs-BnHphH6Q.js";import{T as z}from"./textarea-B0-timp0.js";import{S as ee,a as te,b as se,c as ae,d as C}from"./select-DOSQYT_y.js";import{S as ye}from"./spectral-visuals-s6Jspyuv.js";import{R as ne,C as Ne,aX as je,Z as X,bq as q,c as K,I as we,ap as Ee,d as $e}from"./vendor-icons-B5ISShIx.js";import"./vendor-radix-U50gSQ5i.js";import"./vendor-charts-D6_ndWWt.js";const ue=6626e-37,R=2998e5;function Se(s){let a=0,t=0,l=0;return s>=380&&s<440?(a=-(s-440)/60,l=1):s>=440&&s<490?(t=(s-440)/50,l=1):s>=490&&s<510?(t=1,l=-(s-510)/20):s>=510&&s<580?(a=(s-510)/70,t=1):s>=580&&s<645?(a=1,t=-(s-645)/65):s>=645&&s<=780&&(a=1),`rgb(${Math.round(a*255)},${Math.round(t*255)},${Math.round(l*255)})`}function j(s){return s<450?{name:"SYSTEM",emoji:"⚙",color:"#8b00ff",desc:"OS / kernel / process management"}:s<490?{name:"AUTH",emoji:"🔐",color:"#0050ff",desc:"Authentication / security / sessions"}:s<520?{name:"STREAM",emoji:"⚡",color:"#00cfcf",desc:"Data streams / WebSocket / realtime"}:s<565?{name:"CORE",emoji:"⚙",color:"#00c800",desc:"Core business logic / algorithms"}:s<590?{name:"UI",emoji:"🎨",color:"#cccc00",desc:"UI components / layout / styling"}:s<625?{name:"EVENT",emoji:"📡",color:"#ff8c00",desc:"Events / webhooks / async signals"}:{name:"STORAGE",emoji:"💾",color:"#cc0000",desc:"Database / file I/O / persistence"}}const Z=Array.from({length:128},(s,a)=>380+a/128*400);function H(s){return Z[s.charCodeAt(0)%128]}const Te=40,_e=Math.pow(2,Te);function G(s){return R/(s*1e-9)/_e}let D=null;function xe(){return(!D||D.state==="closed")&&(D=new(window.AudioContext||window.webkitAudioContext)),D.state==="suspended"&&D.resume(),D}function Ae(s,a=.45,t=.2){try{const l=xe(),n=G(s),o=l.createOscillator(),r=l.createGain();o.type="sine",o.frequency.value=n,r.gain.setValueAtTime(0,l.currentTime),r.gain.linearRampToValueAtTime(t,l.currentTime+.012),r.gain.exponentialRampToValueAtTime(.001,l.currentTime+a),o.connect(r),r.connect(l.destination),o.start(l.currentTime),o.stop(l.currentTime+a+.05)}catch{}}function Ce(s,a=1.8){const t=[...new Set(s.map(n=>Math.round(G(n)*10)))].map(n=>n/10),l=Math.max(.03,.18/Math.sqrt(t.length));t.forEach(n=>{try{const o=xe(),r=o.createOscillator(),m=o.createGain();r.type="sine",r.frequency.value=n,m.gain.setValueAtTime(0,o.currentTime),m.gain.linearRampToValueAtTime(l,o.currentTime+.02),m.gain.exponentialRampToValueAtTime(.001,o.currentTime+a),r.connect(m),m.connect(o.destination),r.start(o.currentTime),r.stop(o.currentTime+a+.05)}catch{}})}function re(s,a,t,l,n){const o=j(t),r=n.replace(/[^a-zA-Z0-9]/g,"_").replace(/^_+|_+$/g,"").replace(/_+/g,"_").toLowerCase()||"nexus_fn",m=`@spectral λ=${t.toFixed(1)}nm Ψ=${l} band=${o.name}`;return a==="typescript"?oe(s,t,r,o,m):a==="python"?Re(s,t,r,o,m):a==="html"?ke(s,t,r,o,m):a==="sql"?Pe(s,t,r,o,m):oe(s,t,r,o,m)}function oe(s,a,t,l,n){const o=l.name;return o==="SYSTEM"?`// ${n}
...
`}function Re(s,a,t,l,n){const o=l.name,r=d(t);return o==="AUTH"?`# ${n}
# Domain: Authentication & Security
# Description: ${s}
...
`}function ke(s,a,t,l,n){const o=Math.round((a-380)/400*300);return`<!-- ${n} -->
<!-- Domain: ${l.name} — ${l.desc} -->
<!-- Description: ${s} -->
...
`}function Pe(s,a,t,l,n){return`-- ${n}
-- Domain: ${l.name} — ${l.desc}
-- Description: ${s}
...
`,Ie=`# CE Encoder — WNSP Character Encoding v1.0
# AGPL-3.0 — NexusOS Free Infrastructure
# E = hf  |  λ = c/f  |  Λ = hf/c²
# Runs on any silicon chip today. No server required.
...
`,Me=`// CE Encoder — WNSP Character Encoding v1.0
// AGPL-3.0 — NexusOS Free Infrastructure
// E = hf  |  λ = c/f  |  Λ = hf/c²
