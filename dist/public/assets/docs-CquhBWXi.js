import{j as e}from"./vendor-query-Bv9H5-RN.js";import{u as H}from"./use-page-meta-BRxgrg9H.js";import{C as r}from"./card-CYxvGPJQ.js";import{B as S}from"./button-D59yzw37.js";import{B as q}from"./badge-B9k7b6rb.js";import{P as W}from"./channel-model-C1Dois76.js";import{f as z,L as s}from"./vendor-router-tr6KpmeX.js";import{R as C,I as A,D as T,Z as v,b as c,b7 as D,H as G,S as k,aD as _,f as P,E as l,B as E}from"./vendor-icons-DxZLqVKp.js";import"./index-B7n_VJ-G.js";import"./vendor-radix-U50gSQ5i.js";import"./vendor-charts-D6_ndWWt.js";const b={substrate:{title:"Lambda Gate Substrate v4",icon:c,color:"from-purple-500 to-pink-500",content:[{heading:"Core Theory",text:`The Lambda Gate Substrate is the foundational layer where all NexusOS operations occur as wavefield transformations.
...
- Constitutional enforcement at substrate level`}]},wascii:{title:"WNSP Protocol — Two-Layer Standard",icon:_,color:"from-blue-500 to-cyan-500",content:[{heading:"Overview — Two Operating Runtimes, One Protocol",text:`NexusOS runs on two distinct runtimes that work in sync:
...
**Full stack:** POST /api/wnsp/transmit (CE → SE in one call)`},{heading:"Hilbert Space Channel Model",text:`Each transmission channel is a formal basis vector in a 51,200-dimensional Hilbert space:
...
All 51,200 channels are simultaneously usable without interference. This is not an engineering approximation — it is a mathematical guarantee from the tensor product structure of the Hilbert space.`},{heading:"Handoff Point — CE to SE",text:`The boundary between the two standards is a clean data contract:
...
**API:** GET /api/wnsp/protocol — returns full spec of both standards`},{heading:"AI/OS Channel Coordination Layer",text:`Every AI agent in NexusOS is assigned a unique, deterministically allocated Ψ_channel from the 51,200-dimensional Hilbert space. Orthogonality is a mathematical guarantee — agents cannot interfere with each other regardless of how many are running simultaneously.
...
**Result: 23 passed, 0 failed**`}]},consensus:{title:"Proof of Spectrum Consensus",icon:C,color:"from-green-500 to-emerald-500",content:[{heading:"Spectral Diversity Requirement",text:`Unlike Proof of Work (51% hashpower) or Proof of Stake (51% stake), Proof of Spectrum requires validators across ALL spectral regions.
...
**Consensus Threshold:**
Block requires signatures from ≥5 of 6 spectral regions (83% spectral coverage).`}]},economics:{title:"NXT Token Economics",icon:v,color:"from-amber-500 to-orange-500",content:[{heading:"Token Fundamentals",text:`**Total Supply:** 21,000,000,000 NXT (21 billion)
...
- Inflation is physically impossible`}]},bhls:{title:"BHLS Floor System",icon:k,color:"from-red-500 to-pink-500",content:[{heading:"Basic Human Living Standard",text:`BHLS guarantees every citizen a minimum floor of resources:
...
4. **Governance Allocation** (10%)
   - Voted by Sigma consensus`}]},governance:{title:"Planetary Governance",icon:G,color:"from-indigo-500 to-purple-500",content:[{heading:"Authority Band Registry",text:`7-tier governance hierarchy mapped to wavelengths:
...
- Natural consensus emergence through interference`}]},infrastructure:{title:"K1 Infrastructure",icon:D,color:"from-cyan-500 to-blue-500",content:[{heading:"Kardashev Scale Progress",text:`NexusOS is building toward Type I civilization:
...
**Target:** 5×10¹⁶ watts (penultimate step to Type I)`}]},hardware:{title:"Hardware Control Layer",icon:c,color:"from-rose-500 to-red-500",content:[{heading:"PHR-1 Syncbox Controller",text:`The PHR-1 (Planetary Harmonic Resonator) is the physical hardware interface for NexusOS:
...
As φ → 137.5° and Z → 377Ω, ALP → 0`}]},simulators:{title:"Energy Simulators",icon:v,color:"from-emerald-500 to-teal-500",content:[{heading:"Live Resonance Simulator (7.83 Hz)",text:`Schumann resonance simulator for planetary-scale energy harvesting:
...
Scales with impedance match quality`}]},massless:{title:"Massless Technologies",icon:T,color:"from-violet-500 to-purple-500",content:[{heading:"Core Derivation: Λ = hf/c²",text:`Mass as derivative of frequency:
...
Where C_i = coherence of technology i`}]},catchBasin:{title:"CZC Catch Basin",icon:A,color:"from-blue-500 to-indigo-500",content:[{heading:"Coherence Zenith Coefficient",text:`The CZC Catch Basin is the coherence accumulation mechanism at the heart of NexusOS:
...
- POST /api/czc/sync - Sync with K1 Orchestration`}]},sop:{title:"Spectral Orthogonal Protocol (SOP)",icon:C,color:"from-cyan-500 to-blue-500",content:[{heading:"The Core Idea",text:`Two things are **orthogonal** when they are completely independent — knowing everything about one tells you absolutely nothing about the other.
...
A beam of light twisted with ℓ = 1 is orthogonal to ℓ = 2, ℓ = 3, and so on. You can stack unlimited data streams on the same physical laser beam and separate them perfectly on the other end.`},{heading:"The WNSP Channel Model",text:`NexusOS uses four orthogonal dimensions simultaneously:
...
This is why it is the correct foundation for infrastructure at Kardashev Type I scale: capacity grows with the mathematics, not with the hardware.`}]}};function te(){const p=z(),N=Object.entries(b),w=p.section&&p.section in b?p.section:null,i=w,a=i?b[i]:null,j=a?.icon??null,g=!!w,O=g&&i?`https://wnsp.io/docs/${i}`:"https://wnsp.io/docs",u=g&&a?`${a.title} — NexusOS Documentation`:"NexusOS Documentation — WNSP Protocol, WavelengthScript & CE-SE API",x=g&&a?`${a.title}: ${a.content[0]?.heading??"developer reference"} and full technical documentation for building on NexusOS.`:"Complete developer documentation for NexusOS: WNSP spectral protocol, WavelengthScript language reference, CE-SE encoding pipeline, REST API, NXT token wallet, WNSP VM bytecode, and governance.";return H({title:u,description:x,canonical:O,ogTitle:u,ogDescription:x,twitterTitle:u,twitterDescription:x}),e.jsx("div",{className:"min-h-screen bg-black text-white","data-testid":"page-docs",children:e.jsxs("div",{className:"max-w-7xl mx-auto p-6",children:[e.jsxs("div",{className:"flex items-center justify-between mb-6",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(s,{href:"/developer-matrix",children:e.jsx(S,{variant:"ghost",size:"icon",className:"text-gray-400 hover:text-white","data-testid":"button-home",children:e.jsx(P,{className:"w-5 h-5"})})}),e.jsxs("div",{children:[e.jsx("h1",{className:"text-3xl font-bold tracking-tight","data-testid":"text-title",children:"NexusOS Builder Documentation"}),e.jsx("p",{className:"text-gray-400 text-sm",children:"Technical mechanics for developers building infrastructure"})]})]}),e.jsxs(S,{variant:"outline",size:"sm",onClick:()=>window.history.back(),className:"text-gray-400 hover:text-white border-gray-700 hover:border-gray-500","data-testid":"button-back-previous",children:[e.jsx(P,{className:"w-4 h-4 mr-2"}),"Back to Previous Page"]})]}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-4 gap-6",children:[e.jsx("div",{className:"lg:col-span-1",children:e.jsxs(r,{className:"bg-gray-900/50 border-gray-700 p-4 sticky top-6",children:[e.jsx("h3",{className:"text-sm font-medium text-gray-400 mb-3",children:"DOCUMENTATION"}),e.jsx("nav",{className:"space-y-1",children:N.map(([t,n])=>{const o=n.icon,d=i===t;return e.jsxs(s,{href:`/docs/${t}`,className:`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left transition-colors ${d?"bg-purple-600 text-white":"text-gray-400 hover:bg-gray-800 hover:text-white"}`,"data-testid":`nav-${t}`,children:[e.jsx(o,{className:"w-4 h-4"}),e.jsx("span",{className:"text-sm",children:n.title})]},t)})}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-gray-700",children:[e.jsx("h3",{className:"text-sm font-medium text-gray-400 mb-3",children:"LIVE TOOLS"}),e.jsxs("div",{className:"space-y-1 text-sm",children:[e.jsxs(s,{href:"/ce-code-writer",className:"flex items-center gap-2 text-green-400 hover:text-green-300 font-semibold",children:[e.jsx(c,{className:"w-3 h-3"})," CE Code Writer"]}),e.jsxs(s,{href:"/ce-se-pipeline",className:"flex items-center gap-2 text-cyan-400 hover:text-cyan-300 font-medium",children:[e.jsx(_,{className:"w-3 h-3"})," CE→SE Pipeline"]}),e.jsxs(s,{href:"/wnsp-vm",className:"flex items-center gap-2 text-violet-400 hover:text-violet-300 font-medium",children:[e.jsx(c,{className:"w-3 h-3"})," WNSP Virtual Machine"]}),e.jsxs(s,{href:"/compression-explorer",className:"flex items-center gap-2 text-amber-400 hover:text-amber-300 font-medium",children:[e.jsx(T,{className:"w-3 h-3"})," Compression Explorer"]}),e.jsxs(s,{href:"/spectral-router",className:"flex items-center gap-2 text-gray-400 hover:text-cyan-400",children:[e.jsx(v,{className:"w-3 h-3"})," Spectral Router"]}),e.jsxs(s,{href:"/auth",className:"flex items-center gap-2 text-gray-500 hover:text-gray-400 text-xs",children:[e.jsx(c,{className:"w-3 h-3"})," Sign in to access AI Kernel, Encoding Lab & more"]})]})]}),e.jsxs("div",{className:"mt-4 pt-4 border-t border-gray-700",children:[e.jsx("h3",{className:"text-sm font-medium text-gray-400 mb-3",children:"EXTERNAL PHYSICS"}),e.jsxs("div",{className:"space-y-1 text-sm",children:[e.jsxs("a",{href:"https://en.wikipedia.org/wiki/Planck%27s_law",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 text-gray-400 hover:text-cyan-400",children:[e.jsx(l,{className:"w-3 h-3"})," Planck's Law"]}),e.jsxs("a",{href:"https://en.wikipedia.org/wiki/Maxwell%27s_equations",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 text-gray-400 hover:text-cyan-400",children:[e.jsx(l,{className:"w-3 h-3"})," Maxwell's Equations"]}),e.jsxs("a",{href:"https://en.wikipedia.org/wiki/Orbital_angular_momentum_of_light",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 text-gray-400 hover:text-cyan-400",children:[e.jsx(l,{className:"w-3 h-3"})," OAM of Light"]}),e.jsxs("a",{href:"https://en.wikipedia.org/wiki/Kardashev_scale",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 text-gray-400 hover:text-cyan-400",children:[e.jsx(l,{className:"w-3 h-3"})," Kardashev Scale"]}),e.jsxs("a",{href:"https://en.wikipedia.org/wiki/Schumann_resonances",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 text-gray-400 hover:text-cyan-400",children:[e.jsx(l,{className:"w-3 h-3"})," Schumann Resonance"]})]})]})]})}),e.jsx("div",{className:"lg:col-span-3",children:!i||!a||!j?e.jsxs("div",{"data-testid":"docs-hub",children:[e.jsx(r,{className:"bg-gradient-to-r from-purple-600 to-indigo-600 p-6 mb-6",children:e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"w-14 h-14 rounded-xl bg-white/20 flex items-center justify-center",children:e.jsx(E,{className:"w-7 h-7 text-white"})}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-2xl font-bold",children:"NexusOS Documentation"}),e.jsx("p",{className:"text-white/70",children:"Complete reference for building on the WNSP spectral protocol"})]})]})}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6",children:N.map(([t,n])=>{const o=n.icon;return e.jsx(s,{href:`/docs/${t}`,"data-testid":`hub-card-${t}`,children:e.jsxs(r,{className:"bg-gray-900/50 border-gray-700 p-4 hover:border-purple-500/50 transition-colors cursor-pointer h-full",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx("div",{className:`w-9 h-9 rounded-lg bg-gradient-to-br ${n.color} flex items-center justify-center shrink-0`,children:e.jsx(o,{className:"w-4 h-4 text-white"})}),e.jsx("span",{className:"font-semibold text-white",children:n.title})]}),e.jsx("p",{className:"text-gray-400 text-xs leading-relaxed",children:n.content[0]?.heading??"Developer reference"})]})},t)})})]}):e.jsxs(e.Fragment,{children:[e.jsx(r,{className:`bg-gradient-to-r ${a.color} p-6 mb-6`,children:e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"w-14 h-14 rounded-xl bg-white/20 flex items-center justify-center",children:e.jsx(j,{className:"w-7 h-7 text-white"})}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-2xl font-bold",children:a.title}),e.jsx("p",{className:"text-white/70",children:"Core mechanics for building on this system"})]})]})}),i==="wascii"&&e.jsxs(r,{className:"bg-gray-900/60 border-cyan-500/30 p-6 mb-6","data-testid":"wnsp-protocol-diagram",children:[e.jsxs("h3",{className:"text-lg font-bold mb-6 text-cyan-300 flex items-center gap-2",children:[e.jsx(A,{className:"w-5 h-5"})," WNSP Protocol Stack"]}),e.jsxs("div",{className:"flex flex-col items-center gap-0 font-mono text-sm select-none",children:[e.jsxs("div",{className:"w-full max-w-sm border border-blue-500/60 rounded-xl bg-blue-900/20 p-4",children:[e.jsx("div",{className:"text-blue-300 font-bold mb-2 text-center tracking-wide",children:"CE Layer — Character Encoding"}),e.jsxs("div",{className:"text-gray-400 text-xs space-y-1 text-center",children:[e.jsx("div",{children:"Input: symbols / text"}),e.jsxs("div",{children:["Converts to ordinal tokens"," ",e.jsx("span",{className:"text-blue-300",children:"[0, 1]"})]}),e.jsx("div",{className:"text-blue-400 text-xs mt-1",children:"WNSP-CE v1.0"})]})]}),e.jsxs("div",{className:"flex flex-col items-center text-gray-500 py-1",children:[e.jsx("div",{className:"w-px h-4 bg-gray-600"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"▼"})]}),e.jsxs("div",{className:"w-full max-w-sm border border-gray-600/50 border-dashed rounded-xl bg-gray-800/30 p-3",children:[e.jsx("div",{className:"text-gray-400 font-bold mb-1 text-center text-xs tracking-wide",children:"Legacy Bridge — Optional / Backwards Compatible"}),e.jsx("div",{className:"text-gray-500 text-xs text-center",children:"Preserves char → wavelength compatibility"})]}),e.jsxs("div",{className:"flex flex-col items-center text-gray-500 py-1",children:[e.jsx("div",{className:"w-px h-4 bg-gray-600"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"▼"})]}),e.jsxs("div",{className:"w-full max-w-sm border border-cyan-500/60 rounded-xl bg-cyan-900/20 p-4",children:[e.jsx("div",{className:"text-cyan-300 font-bold mb-2 text-center tracking-wide",children:"SE Layer — Spectral / Physical"}),e.jsxs("div",{className:"text-gray-400 text-xs space-y-1 text-center",children:[e.jsx("div",{children:"Receives CE tokens"}),e.jsxs("div",{children:["Maps to ",e.jsx("span",{className:"text-cyan-300",children:"Ψ_channel"})," ","Hilbert-space basis"]}),e.jsx("div",{className:"text-cyan-200 font-mono mt-2",children:"|λ_i⟩ ⊗ |OAM_j⟩ ⊗ |Pol_k⟩"}),e.jsxs("div",{className:"grid grid-cols-3 gap-1 mt-2",children:[e.jsxs("div",{className:"bg-cyan-900/40 rounded p-1 text-center",children:[e.jsx("div",{className:"text-cyan-300",children:"WDM"}),e.jsx("div",{className:"text-white font-bold",children:"256"})]}),e.jsxs("div",{className:"bg-cyan-900/40 rounded p-1 text-center",children:[e.jsx("div",{className:"text-cyan-300",children:"OAM"}),e.jsx("div",{className:"text-white font-bold",children:"50"})]}),e.jsxs("div",{className:"bg-cyan-900/40 rounded p-1 text-center",children:[e.jsx("div",{className:"text-cyan-300",children:"Pol"}),e.jsx("div",{className:"text-white font-bold",children:"H/V"})]})]}),e.jsx("div",{className:"text-cyan-400 text-xs mt-1",children:"WNSP-SE v1.0"})]})]}),e.jsxs("div",{className:"flex flex-col items-center text-gray-500 py-1",children:[e.jsx("div",{className:"w-px h-4 bg-gray-600"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"▼"})]}),e.jsxs("div",{className:"w-full max-w-sm border border-purple-500/60 rounded-xl bg-purple-900/20 p-4",children:[e.jsx("div",{className:"text-purple-300 font-bold mb-2 text-center tracking-wide",children:"Physical Transmission — EM Wave Substrate"}),e.jsxs("div",{className:"text-gray-400 text-xs space-y-1 text-center",children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-white font-bold text-base",children:W})," ","orthogonal channels"]}),e.jsx("div",{className:"text-purple-200 font-mono mt-1",children:"Ψ_ijk = |λ_i⟩ ⊗ |OAM_j⟩ ⊗ |Pol_k⟩"}),e.jsx("div",{className:"text-gray-500 mt-1",children:"⟨Ψ_i | Ψ_j⟩ = 0   for i ≠ j"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 mt-2",children:[e.jsxs("div",{className:"bg-purple-900/40 rounded p-1 text-center",children:[e.jsx("div",{className:"text-purple-300 font-mono",children:"E = hc/λ"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"Photon energy"})]}),e.jsxs("div",{className:"bg-purple-900/40 rounded p-1 text-center",children:[e.jsx("div",{className:"text-purple-300 font-mono",children:"Λ = E/c²"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"Lambda mass"})]})]})]})]})]})]}),e.jsx("div",{className:"space-y-6",children:a.content.map((t,n)=>e.jsxs(r,{className:"bg-gray-900/50 border-gray-700 p-6","data-testid":`content-block-${n}`,children:[e.jsx("h3",{className:"text-lg font-bold mb-4 text-purple-300",children:t.heading}),e.jsx("div",{className:"prose prose-invert max-w-none",children:t.text.split(`

`).map((o,d)=>{if(o.startsWith("|")){const f=o.split(`
`).filter(h=>h.trim());return e.jsx("div",{className:"overflow-x-auto my-4",children:e.jsx("table",{className:"w-full text-sm",children:e.jsx("tbody",{children:f.map((h,m)=>{if(h.includes("---"))return null;const I=h.split("|").filter(y=>y.trim()),M=m===0?"th":"td";return e.jsx("tr",{className:m===0?"border-b border-gray-700":"",children:I.map((y,R)=>e.jsx(M,{className:`px-3 py-2 text-left ${m===0?"text-gray-400 font-medium":"text-gray-300"}`,children:y.trim()},R))},m)})})})},d)}const L=(f=>f.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"))(o).replace(/\*\*(.*?)\*\*/g,'<strong class="text-white">$1</strong>').replace(/`(.*?)`/g,'<code class="bg-gray-800 px-1 rounded text-cyan-300">$1</code>');return e.jsx("p",{className:"text-gray-300 mb-3 whitespace-pre-wrap",dangerouslySetInnerHTML:{__html:L}},d)})})]},n))}),e.jsxs(r,{className:"bg-gray-900/30 border-gray-700 p-6 mt-6",children:[e.jsxs("h3",{className:"text-lg font-bold mb-4 flex items-center gap-2",children:[e.jsx(E,{className:"w-5 h-5 text-purple-400"}),"Key Equations Reference"]}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-3 gap-3 text-sm",children:[e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg",children:[e.jsx("div",{className:"text-purple-300 font-mono",children:"E = hf"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"Photon energy"})]}),e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg",children:[e.jsx("div",{className:"text-cyan-300 font-mono",children:"Λ = hf/c²"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"Lambda mass"})]}),e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg",children:[e.jsx("div",{className:"text-green-300 font-mono",children:"c = fλ"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"Wave equation"})]}),e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg",children:[e.jsx("div",{className:"text-amber-300 font-mono",children:"∇×E = -∂B/∂t"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"Maxwell curl"})]}),e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg",children:[e.jsx("div",{className:"text-pink-300 font-mono",children:"Ĥ = hν + αK̂² + βL̂"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"Hamiltonian"})]}),e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg",children:[e.jsx("div",{className:"text-red-300 font-mono",children:"T = Σ|c|²cos²(Δφ)"}),e.jsx("div",{className:"text-gray-500 text-xs",children:"Interference trust"})]})]})]}),e.jsx(r,{className:"bg-gray-900/50 border-gray-700 p-6 mt-6","data-testid":"license-footer",children:e.jsxs("div",{className:"flex items-start gap-4",children:[e.jsx("div",{className:"p-2 rounded-lg bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-blue-500/30",children:e.jsx(k,{className:"w-6 h-6 text-blue-400"})}),e.jsxs("div",{className:"flex-1",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx("h3",{className:"text-lg font-bold text-white",children:"AGPL-3.0 License"}),e.jsx(q,{className:"bg-blue-500/20 text-blue-300 border-blue-500/30",children:"Copyleft"})]}),e.jsxs("p",{className:"text-gray-400 text-sm mb-3",children:["WNSP Protocol, Lambda Gate Substrate, NXT Token Economics, and all associated implementations are licensed under the",e.jsx("a",{href:"https://www.gnu.org/licenses/agpl-3.0.en.html",target:"_blank",rel:"noopener noreferrer",className:"text-blue-400 hover:text-blue-300 mx-1 underline",children:"GNU Affero General Public License v3.0"}),"(AGPL-3.0)."]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-3 text-xs",children:[e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg border border-gray-700",children:[e.jsx("div",{className:"text-green-400 font-semibold mb-1",children:"You CAN:"}),e.jsxs("ul",{className:"text-gray-400 space-y-1",children:[e.jsx("li",{children:"Use commercially"}),e.jsx("li",{children:"Modify and distribute"}),e.jsx("li",{children:"Patent use"})]})]}),e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg border border-gray-700",children:[e.jsx("div",{className:"text-amber-400 font-semibold mb-1",children:"You MUST:"}),e.jsxs("ul",{className:"text-gray-400 space-y-1",children:[e.jsx("li",{children:"Disclose source code"}),e.jsx("li",{children:"Include license & copyright"}),e.jsx("li",{children:"Share network modifications"})]})]}),e.jsxs("div",{className:"p-3 bg-gray-800/50 rounded-lg border border-gray-700",children:[e.jsx("div",{className:"text-red-400 font-semibold mb-1",children:"You CANNOT:"}),e.jsxs("ul",{className:"text-gray-400 space-y-1",children:[e.jsx("li",{children:"Sublicense"}),e.jsx("li",{children:"Hold liable"}),e.jsx("li",{children:"Close-source derivatives"})]})]})]}),e.jsxs("div",{className:"mt-4 pt-4 border-t border-gray-700 text-center",children:[e.jsx("p",{className:"text-gray-500 text-xs",children:"© 2024-2025 NexusOS. All rights reserved under AGPL-3.0."}),e.jsx("p",{className:"text-gray-600 text-xs mt-1",children:"Physics principles (E=hf, Maxwell's equations) are public domain. Implementation is protected."})]})]})]})})]})})]})]})})}export{te as default};
