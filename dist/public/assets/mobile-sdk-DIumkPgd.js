import{a as i,j as e}from"./vendor-react-Dbq4-fkY.js";import{L as I}from"./vendor-router-BNSZfxZx.js";import{f as F,bw as V,b as G,R as _,Z as H,G as q,al as U,d as E,ap as Y,B as Z,aj as Q}from"./vendor-icons-taAWd6pV.js";function k(n){return n<450?"#8b00ff":n<495?"#2563eb":n<520?"#06b6d4":n<565?"#16a34a":n<590?"#ca8a04":n<625?"#ea580c":"#dc2626"}function X(n){return n<450?"SYSTEM":n<495?"AUTH":n<520?"STREAM":n<565?"LOGIC":n<590?"INTERFACE":n<625?"EVENT":"STORAGE"}function R(n){const c=n.toUpperCase().split("").map(o=>o.charCodeAt(0)).filter(o=>o>=32&&o<=126);c.length||c.push(77);const f=c.reduce((o,l)=>o+l,0)/c.length,p=parseFloat((380+(f-32)/94*400).toFixed(2)),g=parseFloat((299792458/(p*1e-9)/1e12).toFixed(4)),S=Math.floor((p-380)/4)+1,r=c.reduce((o,l)=>o+l,0)%50,v=c.length%2===0?"H":"V",u=`Ψ(${S},${r},${v})`,C=X(p),x=6626e-37,w=2998e5,s=x*(g*1e12),h=s/(w*w);return{nm:p,thz:g,wdm:S,oam:r,pol:v,psi:u,band:C,energyJ:s,lambdaKg:h,uri:`wnsp://${u}/${n.toLowerCase().replace(/\s+/g,"-")}`}}const $=`// NexusOS WASCII SDK for iOS — Swift
