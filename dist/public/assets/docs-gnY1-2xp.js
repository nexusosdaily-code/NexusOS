import{j as e}from"./vendor-query-Bv9H5-RN.js";import{u as M}from"./use-page-meta-BRxgrg9H.js";import{C as s}from"./card-Cja6eR9_.js";import{B as w}from"./button-IMjXHTFq.js";import{B as R}from"./badge-DB_1vnD-.js";import{P as H}from"./channel-model-C1Dois76.js";import{f as q,L as t}from"./vendor-router-tr6KpmeX.js";import{R as N,I as j,D as C,Z as v,b as c,b7 as W,H as z,S as P,aD as E,f as S,E as o,B as G}from"./vendor-icons-B5ISShIx.js";import"./index-oAtzuvcb.js";import"./vendor-radix-U50gSQ5i.js";import"./vendor-charts-D6_ndWWt.js";const b={substrate:{title:"Lambda Gate Substrate v4",icon:c,color:"from-purple-500 to-pink-500",content:[{heading:"Core Theory",text:`The Lambda Gate Substrate is the foundational layer where all NexusOS operations occur as wavefield transformations.
...
- Constitutional enforcement at substrate level`}]},wascii:{title:"WNSP Protocol — Two-Layer Standard",icon:E,color:"from-blue-500 to-cyan-500",content:[{heading:"Overview — Two Operating Runtimes, One Protocol",text:`NexusOS runs on two distinct runtimes that work in sync:
...
**Result: 23 passed, 0 failed**`}]},consensus:{title:"Proof of Spectrum Consensus",icon:N,color:"from-green-500 to-emerald-500",content:[{heading:"Spectral Diversity Requirement",text:`Unlike Proof of Work (51% hashpower) or Proof of Stake (51% stake), Proof of Spectrum requires validators across ALL spectral regions.
...
- Inflation is physically impossible`}]},bhls:{title:"BHLS Floor System",icon:P,color:"from-red-500 to-pink-500",content:[{heading:"Basic Human Living Standard",text:`BHLS guarantees every citizen a minimum floor of resources:
...
4. **Governance Allocation** (10%)
   - Voted by Sigma consensus`}]},governance:{title:"Planetary Governance",icon:z,color:"from-indigo-500 to-purple-500",content:[{heading:"Authority Band Registry",text:`7-tier governance hierarchy mapped to wavelengths:
...
- Natural consensus emergence through interference`}]},infrastructure:{title:"K1 Infrastructure",icon:W,color:"from-cyan-500 to-blue-500",content:[{heading:"Kardashev Scale Progress",text:`NexusOS is building toward Type I civilization:
...
Scales with impedance match quality`}]},massless:{title:"Massless Technologies",icon:C,color:"from-violet-500 to-purple-500",content:[{heading:"Core Derivation: Λ = hf/c²",text:`Mass as derivative of frequency:
...
Where C_i = coherence of technology i`}]},catchBasin:{title:"CZC Catch Basin",icon:j,color:"from-blue-500 to-indigo-500",content:[{heading:"Coherence Zenith Coefficient",text:`The CZC Catch Basin is the coherence accumulation mechanism at the heart of NexusOS:
...
- POST /api/czc/sync - Sync with K1 Orchestration`}]},sop:{title:"Spectral Orthogonal Protocol (SOP)",icon:N,color:"from-cyan-500 to-blue-500",content:[{heading:"The Core Idea",text:`Two things are **orthogonal** when they are completely independent — knowing everything about one tells you absolutely nothing about the other.
