import{a as j,j as e}from"./vendor-query-BqLxTKzc.js";import{u as G}from"./use-page-meta-BHtL6y3o.js";import{L as W,d as P,Z as z,C as R,e as O,R as B,B as H}from"./index-CPA9acPq.js";import{A as _}from"./arrow-left-C7uD7FyP.js";import{L as q}from"./layers-DWSMRckk.js";import{A as D}from"./atom-C2eo9Q2p.js";import{P as F}from"./play-DD49IWAI.js";import{C as K}from"./chevron-right-C0xYZSZE.js";import"./vendor-radix-Bg2fqeVo.js";import"./vendor-charts-DAxvRQzT.js";function E(d){return d<450?"#8b00ff":d<495?"#2563eb":d<520?"#06b6d4":d<565?"#16a34a":d<590?"#ca8a04":d<625?"#ea580c":"#dc2626"}function $(d){return d<450?"SYSTEM":d<495?"AUTH":d<520?"STREAM":d<565?"LOGIC":d<590?"INTERFACE":d<625?"EVENT":"STORAGE"}function g(d){const b=d.toUpperCase().split("").map(p=>p.charCodeAt(0)).filter(p=>p>=32&&p<=126);b.length||b.push(77);const f=b.reduce((p,n)=>p+n,0)/b.length,o=parseFloat((380+(f-32)/94*400).toFixed(2)),c=parseFloat((299792458/(o*1e-9)/1e12).toFixed(2)),w=Math.floor((o-380)/4)+1,s=b.reduce((p,n)=>p+n,0)%100,S=b.length%2===0?"H":"V";return{nm:o,thz:c,psi:`Ψ(${w},${s},${S})`,band:$(o)}}function U(d,b){if(!d.trim())return"";const f=d.split(`
