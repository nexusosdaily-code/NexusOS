...
node.register("TrustLayer", @468.3nm)`},{label:"Computation Proof",color:"#10b981",src:z},{label:"Fock State — â†â",color:"#f59e0b",src:`∿ WLS v2.0 — Fock state execution model
