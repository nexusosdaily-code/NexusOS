import{a as l,j as e}from"./vendor-query-BqLxTKzc.js";import{L as r,h as d,C as p,E as g}from"./index-YDKJnxMP.js";import{C as f}from"./chevron-up-kxmCMjKG.js";import{C as y}from"./chevron-down-CDKC0zE7.js";import"./vendor-radix-Bg2fqeVo.js";import"./vendor-charts-DAxvRQzT.js";function m({text:a,label:i="Copy answer"}){const[t,s]=l.useState(!1);return e.jsxs("button",{onClick:()=>{navigator.clipboard.writeText(a),s(!0),setTimeout(()=>s(!1),2e3)},className:"flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold transition-all",style:t?{background:"#16a34a20",color:"#4ade80",border:"1px solid #16a34a40"}:{background:"#f59e0b15",color:"#f59e0b",border:"1px solid #f59e0b30"},children:[t?e.jsx(d,{size:12}):e.jsx(p,{size:12}),t?"Copied!":i]})}function w({q:a,tag:i,answer:t}){const[s,n]=l.useState(!1),u=t.split(`
`).slice(0,3).join(`
`);return e.jsxs("div",{className:"rounded-xl border border-slate-800 bg-slate-900/40 overflow-hidden",children:[e.jsxs("div",{className:"p-5 space-y-2",children:[e.jsxs("div",{className:"flex items-start gap-3",children:[e.jsx("span",{className:"text-[10px] font-mono bg-slate-800 text-slate-400 px-2 py-0.5 rounded flex-shrink-0 mt-0.5",children:i}),e.jsx("p",{className:"text-sm font-bold text-white leading-snug",children:a})]}),e.jsx("p",{className:"text-xs text-slate-500 leading-relaxed line-clamp-2 pl-14",children:u})]}),s&&e.jsx("div",{className:"border-t border-slate-800 bg-slate-950/40 p-5",children:e.jsx("pre",{className:"text-xs text-slate-300 leading-relaxed whitespace-pre-wrap font-sans",children:t})}),e.jsxs("div",{className:"px-5 py-3 border-t border-slate-800/60 flex items-center gap-3 flex-wrap",children:[e.jsx(m,{text:t}),e.jsx("button",{onClick:()=>n(x=>!x),className:"flex items-center gap-1 text-xs text-slate-500 hover:text-slate-300 transition-colors",children:s?e.jsxs(e.Fragment,{children:[e.jsx(f,{size:12})," Hide preview"]}):e.jsxs(e.Fragment,{children:[e.jsx(y,{size:12})," Preview"]})}),e.jsxs("span",{className:"ml-auto text-[10px] font-mono text-slate-700",children:[t.length," chars · ~",Math.ceil(t.split(" ").length/200)," min read"]})]})]})}function c({size:a=16}){return e.jsx("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M12.023 20.609c-.79 1.67-2.238 3.391-4.585 3.391h-.87l.87-1.74c-3.625-.52-6.438-3.625-6.438-7.26 0-4.063 3.313-7.37 7.398-7.37 4.086 0 7.407 3.307 7.407 7.37 0 2.17-.913 4.16-2.376 5.53.14.5.375.85.617.97.46.226 1.37.018 2.15-.63l.38 1.01c-1.37 1.34-2.826 1.66-4.553.729zm-3.625-1.07c.5-.24.875-.6 1.25-1.12-.47-.24-.913-.53-1.313-.87l.84-1.49c.353.33.737.63 1.14.87.22-.55.33-1.14.33-1.78 0-2.65-1.91-4.8-4.26-4.8-2.355 0-4.265 2.15-4.265 4.8 0 2.65 1.91 4.8 4.265 4.8.75 0 1.46-.2 2.013-.41zm6.344 2.672c.96.8 2.07.96 2.81.57.5-.265.82-.7.96-1.24-2.15 0-3.92-1.72-3.92-3.84 0-.66.175-1.28.48-1.82-.39-.74-.63-1.58-.63-2.48 0-3.01 2.45-5.46 5.46-5.46s5.46 2.45 5.46 5.46-2.45 5.46-5.46 5.46c-.38 0-.75-.04-1.11-.11-.56.7-1.24 1.28-2.05 1.46z"})})}const o="https://wnsp.io",h=[{tag:"Future of internet",q:"What will replace the internet?",answer:`The honest answer is: not one thing. The internet will be replaced by a stack, and the bottom layer of that stack will be photonic.
...
The code is AGPL-3.0 open source. The encoder is on npm (npm install nexusos-ce-encoder, 95 weekly downloads in its first week). The full specification is at ${o}/protocol.
...
This is what native photonic communication looks like. You can try the live encoder at ${o}/start, or install it:
...
The encoder is on npm (nexusos-ce-encoder, 95 weekly downloads in its first week). The GitHub repo has over 2,200 clones in two weeks. The full specification is public at ${o}/protocol.
