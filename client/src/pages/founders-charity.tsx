...
const SAFEGUARDS = [
  ...
  { article: "C-0002", title: "Immutable Rights", color: "#a78bfa", text: "No transaction may reduce any citizen's balance below the Basic Human Living Standard of 1,150 NXT/month provided in services through the charity. Charitable disbursements cannot override citizen rights." },
