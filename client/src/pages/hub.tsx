...
const APP_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "⚡ The Mechanism — Controlled Octave Inversion", href: "/matter-protocol",     Icon: Zap },
      { title: "🌐 The Address — Ψ as Universal Namespace",    href: "/universal-address",   Icon: Globe },
