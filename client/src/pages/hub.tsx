...
const APP_SECTIONS = [
  {
    ...
    items: [
      ...
      { title: "⚛ Silicon Bridge",    href: "/silicon-bridge", Icon: Cpu },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "⚖ Compliance Monitor", href: "/constitution/compliance", Icon: Activity },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "§1 Theory of Compression States",              href: "/oscillating-quanta",          Icon: Waves },
      { title: "§2 The Universal ONE — f₀ First Oscillation", href: "/universal-one",               Icon: Waves },
      { title: "§3 Unified Compression Theory",               href: "/unified-compression-theory",  Icon: Zap },
      { title: "§4 The Mechanism — Controlled Octave Inversion", href: "/matter-protocol",          Icon: Zap },
      ...
      { title: "§10 The Exchange — Polariton Formation",      href: "/polariton-exchange",      Icon: Zap },
      { title: "§11 The Emitter — Purcell Factor",            href: "/the-emitter",             Icon: Radio },
      { title: "§12 The Network — Tight-Binding Dispersion",  href: "/the-network",             Icon: Waves },
      { title: "§13 The Observer — Dispersive Readout",       href: "/the-observer",            Icon: Activity },
      { title: "§14 The Memory — Quantum Coherence Time",     href: "/the-memory",              Icon: Activity },
      { title: "§15 The Void — Cosmic ZPE Floor",             href: "/cosmic-lattice",          Icon: Globe },
      { title: "§16 The Entangler — Bell States",             href: "/the-entangler",           Icon: Zap },
      { title: "§17 The Field — [â,â†]=1 Primordial Substrate", href: "/the-field",            Icon: Waves },
      { title: "CE-SE Pipeline",                         href: "/ce-se-pipeline",     Icon: Zap },
