    ...
    content: [
      {
        ...
        text: `NexusOS offers a Basic Human Living Standard as a service — a minimum floor of resources for every citizen:
...
"No transaction may reduce a citizen's balance below the Basic Human Living Standard of 1,150 NXT/month — the service floor offered by NexusOS through the orbital treasury."

**Enforcement:**
- Substrate rejects transactions violating the service floor
- Cannot be overridden by governance
- Hardcoded into Lambda Gate operations`
      },
      {
        heading: "Funding Mechanism",
        text: `The Basic Human Living Standard service floor is funded through:
...
**C-0002: Immutable Rights**
The Basic Human Living Standard service floor of 1,150 NXT/month cannot be violated by any transaction.
...
const INTERNAL_RESOURCES = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Basic Human Living Standard", docSection: "ihr", description: "1,150 NXT/month service floor offered by NexusOS through the orbital treasury" },
