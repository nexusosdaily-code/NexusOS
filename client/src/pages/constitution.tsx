      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10">
        ...
        <div className="space-y-6">
          ...
          <ArticleCard
            ...
            formal="1,150 NXT/month is the measured monthly service consumption per citizen — the gauge of what the charity delivers across 7 service categories. No transaction may reduce a citizen's balance below this consumption baseline. The floor and the consumption measure are the same number by design."
          ...
          >
            {c0002 && (
              <div className="space-y-3">
                <div className="flex items-center justify-between text-[10px] font-mono text-white/30 uppercase tracking-wider">
                  <span>Basic Human Living Standard — 1,150 NXT / month · monthly service consumption gauge</span>
                ...
                <div className="pt-1 border-t border-white/5 text-[10px] font-mono text-white/20">
                  Enforced at: wallet transfer endpoint — transfer rejected if sender would drop below the monthly service consumption baseline of 1,150 NXT
                </div>
              </div>
            )}
          </ArticleCard>
